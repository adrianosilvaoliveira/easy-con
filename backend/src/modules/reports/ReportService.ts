...
export class ReportService {
  ...
  static async stockPdf(res: Response, userName?: string) {
    ...
    await PdfProvider.generate(res, {
      ...
      landscape: true,
      columns: [
        { header: 'Código', key: 'code', width: 1.1 },
        { header: 'Produto', key: 'product', width: 3.4 },
        { header: 'Categoria', key: 'category', width: 1.6 },
        { header: 'Local', key: 'location', width: 2.0 },
        { header: 'Lote', key: 'lot', width: 1.5 },
        { header: 'Validade', key: 'expiry', width: 1.3 },
        { header: 'Un.', key: 'unit', width: 0.7 },
        { header: 'Qtd', key: 'qty', width: 0.8 },
      ],
  ...
  static async byLocationPdf(res: Response, filters: BatchReportFilters, userName?: string) {
    ...
    await PdfProvider.generate(res, {
      ...
      columns: [
        { header: 'Local', key: 'location', width: 2.0 },
        { header: 'Código', key: 'code', width: 1.2 },
        { header: 'Produto', key: 'product', width: 3.2 },
        { header: 'Lote', key: 'lot', width: 1.5 },
        { header: 'Validade', key: 'expiry', width: 1.3 },
